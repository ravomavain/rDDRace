...
MACRO_CONFIG_INT(SvRescue, sv_rescue, 0, 0, 1, CFGFLAG_SERVER, "Allow players to use /r", 3)
MACRO_CONFIG_INT(SvRescueTime, sv_rescue_time, 0, 0, 9999, CFGFLAG_SERVER, "Time between freeze and /r usage", 3)
