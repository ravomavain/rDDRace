...
CONSOLE_COMMAND("jail", "v?i", CFGFLAG_SERVER|CMDFLAG_CHEAT|CMDFLAG_HELPERCMD, ConJail, this, "Put player v in jail for i seconds (infinite by default)", 2)
CONSOLE_COMMAND("unjail", "v", CFGFLAG_SERVER|CMDFLAG_CHEAT|CMDFLAG_HELPERCMD, ConUnJail, this, "Put player v out of jail", 2)
