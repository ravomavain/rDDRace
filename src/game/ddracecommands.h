...
CONSOLE_COMMAND("teleto", "vi", CFGFLAG_SERVER|CMDFLAG_CHEAT|CMDFLAG_HELPERCMD, ConTeleportTo, this, "Teleports player v to teleporter i", IConsole::CONSOLELEVEL_ADMIN)
CONSOLE_COMMAND("jail", "?vi", CFGFLAG_SERVER|CMDFLAG_CHEAT|CMDFLAG_HELPERCMD, ConJail, this, "Put player v in jail for i seconds (infinite by default)", IConsole::CONSOLELEVEL_ADMIN)
CONSOLE_COMMAND("unjail", "?v", CFGFLAG_SERVER|CMDFLAG_CHEAT|CMDFLAG_HELPERCMD, ConUnJail, this, "Put player v out of jail", IConsole::CONSOLELEVEL_ADMIN)
