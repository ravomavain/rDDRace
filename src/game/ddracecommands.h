...
CONSOLE_COMMAND("teleto", "vi", CFGFLAG_SERVER|CMDFLAG_CHEAT, ConTeleportTo, this, "Teleports player v to teleporter i", IConsole::CONSOLELEVEL_ADMIN)
CONSOLE_COMMAND("jail", "?vi", CFGFLAG_SERVER, ConJail, this, "Put player v in jail for i seconds (infinite by default)", IConsole::CONSOLELEVEL_ADMIN)
CONSOLE_COMMAND("unjail", "?v", CFGFLAG_SERVER, ConUnJail, this, "Put player v out of jail", IConsole::CONSOLELEVEL_ADMIN)
