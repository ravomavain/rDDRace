...
CHAT_COMMAND("rescue", "", CFGFLAG_CHAT, ConRescue, this, "Use it to go back if you are stuck");
CHAT_COMMAND("r", "", CFGFLAG_CHAT, ConRescue, this, "Use it to go back if you are stuck");
